...
function AdminDashboard() {
  ...
  const navigateToAdminFileUpload = () => {
    //  navigate 
    navigate('/AdminFileUpload');
  };

  const navigateToAdminPlanning = () => {
    navigate('/AdminPlanning');
  }

  const navigateToAdminSlicing =() => {
    navigate('/AdminSlicing');
  }

  const navigateToAdminBook = () => {
    navigate('/AdminBook')
  }
  ...
  const navigateToAdminUserDashboard=()=>{
    navigate('/AdminUserDashboard')
  }
  const navigateToAdminCustomerDashboard=()=>{
  ...
  return (
    ...
    <div className="Container">
      ...
      <div className="pages">
        ...
        <div className="pages">
          <p className='home' style={{ color: 'hsl(180.3deg 100% 39.02%)' }} onClick={navigateToAdminDashboard}>Home</p>
        </div>
        <div className="pages">
            ...
            <div  className="Navbar"onClick={navigateToAdminPlanning}>Plan</div>
            <div className="Navbar"onClick ={navigateToAdminFileUpload}>File Upload</div>
            <div className="Navbar"onClick={navigateToAdminSlicing}>Slice</div>
            <div className="Navbar"onClick={navigateToAdminBook}>Book</div>
            <div className="Navbar" onClick={navigateToAdminArea}>View</div>
            
          </div>
          </div>
        
        <div className="pages">
          <p className='headerText' onClick={navigateToAdminUserDashboard}>Users</p>
        </div>
        <div className="pages">
          <p className='headerText' onClick={navigateToAdminCustomerDashboard}>Customers</p>
        </div>
